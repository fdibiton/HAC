...
import hac.data.evaluation as DE
...
class DatasetCatalog:
    ...
    @classmethod
    def build(
        cls, name: str, root: str | Path, split: str, transform: Callable | None = None, subsample_ratio: float | None = None
    ):
        ...
        if subsample_ratio is not None:
            assert name == "coco", "Subsampling is only supported for the COCO dataset."
            return cls.CONSTRUCTORS[name](root=root, split=split, transform=transform, subsample_ratio=subsample_ratio)
