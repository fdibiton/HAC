...
class LazyFactory:
    ...
    def build_val_dataloader(cfg: DictConfig):
        # Instantiate dataset and wrap in dataloader.
        return DataLoader(
            instantiate(cfg.dataset_val),
            num_workers=cfg.val.num_workers,
            batch_size=cfg.val.total_batch_size // dist.get_world_size(),
            drop_last=True,
            pin_memory=True,
        )
    ...
    @staticmethod
    def build_generic_config(cfg: DictConfig, key: str):
        generic_config = instantiate(cfg.get(key, None))
    ...
    @staticmethod
    def build_curv_scheduler(cfg: DictConfig):
        return instantiate(cfg.curv_scheduler.scheduler)
